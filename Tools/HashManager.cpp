...
bool HashManager::isMeathookModInGameFolder()
{
	...
	std::string meathHookModFilePathStr = HashManager::getMD5MatchFilePath(Hashes::MeathookModHashes, currentPathStr,
																		   Hashes::MeathookModFileExtension);
...
bool HashManager::isPreviousModVersionInGameFolder()
{
	...
	std::string conflictingModPathStr = HashManager::getMD5MatchFilePath(Hashes::PreviousModVersionsHashes,
																		 currentPathStr,
																		 Hashes::PreviousModsVersionsFileExtension);
	...
	logErr("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
	logErr("Found previous version of this mod in the game folder, as a result this mod will now close. Please close the game and delete: %s and start the game again",
		   conflictingModPathStr.c_str());
	logErr("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
	return true;
}

std::string HashManager::getMD5MatchFilePath(const std::vector<std::string>& md5List, const std::string& folderPath,
											 std::string                     fileEtentionToCheck)
{
