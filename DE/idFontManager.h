...
public:
	...
	//? i'm fed up of this. Will not use text inside boxes to indicate countdown will use self maderect bars instead, will only use text for the health, armor and ammo and that is it. Basically i got to a point where i managed to align eternal 90 but it was ok for scale 15 and no way to align it of the y axis for lower value . I'm not even sure why the f i'm doing all this anyway, way too much work for what
